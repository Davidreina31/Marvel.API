    ...
    public partial class firstMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersHeroes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UsersHeroes_Heroes_HeroId",
                        column: x => x.HeroId,
                        principalTable: "Heroes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UsersHeroes_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsersHeroes_HeroId",
                table: "UsersHeroes",
                column: "HeroId");

            migrationBuilder.CreateIndex(
                name: "IX_UsersHeroes_UserId",
                table: "UsersHeroes",
                column: "UserId");
        }
